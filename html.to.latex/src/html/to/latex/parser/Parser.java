...
import html.to.latex.io.IReader;
import html.to.latex.io.InputFileReader;
import html.to.latex.io.InputStringReader;
...
public class Parser {
	...
	public Parser(String input) throws FatalErrorException{
	...
	/**
	 * Parses element. Stores element attributes in {@link ElementStart ElementStart} object if it's
	 * a start element.
	 * 
	 * @param elementString
	 *            string containing the element with its attributes (but without leading
	 *            &quot;&lt;&quot; and ending &quot;&gt;&quot;)
