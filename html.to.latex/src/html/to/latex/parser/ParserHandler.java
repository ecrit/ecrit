package html.to.latex.parser;

import html.to.latex.converter.Converter;
 ...
 * {@link Converter Convertor} class.
 */
public class ParserHandler implements IParserHandler {
	 ...
	 * {@link Converter#commonElementStart(ElementStart) commonElementStart()} for non-special
	 * elements and specials methods for the elements requiring special care (ie.
	 * {@link Converter#tableRowStart(ElementStart) tableRowStart()} for
	 * <code>&lt;table&gt;</table>)
	 * 
	 * @param element
	 ...
	 * {@link Converter#commonElementEnd(ElementEnd, ElementStart) commonElementEnd()} for
	 * non-special elements and specials methods for the elements requiring special care (ie.
	 * {@link Converter#tableRowEnd(ElementEnd, ElementStart) tableRowEnd()} for
	 * <code>&lt;/table&gt;</table>)
	 * 
	 * @param element
	 *            end element reached
	 ...
	 * {@link Converter#characters(String) characters()} method of the {@link Converter Convertor}
	 * class.
	 * 
	 * @param content
	...
	/**
	 * Called when the comment is reached in input document. Calls {@link Converter#comment(String)
	 * comment()} method of the {@link Converter Convertor} class.
	 * 
	 * @param comment
	 *            ie. &quot;foo&quot; for the &quot;&lt;!--&gt;foo&lt;/--&gt;&quot;
	 */
	...
	/**
	 * Called when the whole input document is read. Calls {@link Converter#destroy() destroy()}
	 * method of the {@link Converter Convertor} class.
	 */
