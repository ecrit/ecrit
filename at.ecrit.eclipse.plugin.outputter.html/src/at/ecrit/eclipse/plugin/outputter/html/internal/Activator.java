...
public class Activator implements BundleActivator {
	...
	public static final String PLUGIN_ID = "at.ecrit.eclipse.plugin.outputter.html";
	...
	public void start(BundleContext context) throws Exception {
		...
		freemarkerConfig.setClassForTemplateLoading(HTMLOutputter.class, "/rsc/templates");
