...
/**
 * <!-- begin-user-doc --> An implementation of the model object '<em><b>Initiatable Item</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * <ul>
 * <li>{@link at.ecrit.document.model.ecritdocument.impl.InitiatableItemImpl#getItem <em>Item</em>}</li>
 * <li>{@link at.ecrit.document.model.ecritdocument.impl.InitiatableItemImpl#getItemType <em>Item
 * Type</em>}</li>
 * <li>{@link at.ecrit.document.model.ecritdocument.impl.InitiatableItemImpl#getContainingWindow
 * <em>Containing Window</em>}</li>
 * <li>{@link at.ecrit.document.model.ecritdocument.impl.InitiatableItemImpl#getContainingPart <em>
 * Containing Part</em>}</li>
 * <li>{@link at.ecrit.document.model.ecritdocument.impl.InitiatableItemImpl#getContainingMenu <em>
 * Containing Menu</em>}</li>
 * <li>{@link at.ecrit.document.model.ecritdocument.impl.InitiatableItemImpl#getContainingToolbar
 * <em>Containing Toolbar</em>}</li>
 * <li>{@link at.ecrit.document.model.ecritdocument.impl.InitiatableItemImpl#getVisibleWhen <em>
 * Visible When</em>}</li>
 * <li>{@link at.ecrit.document.model.ecritdocument.impl.InitiatableItemImpl#getAssociatedStep <em>
 * Associated Step</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class InitiatableItemImpl extends MinimalEObjectImpl.Container implements InitiatableItem {
	...
	/**
	 * The cached value of the '{@link #getContainingWindow() <em>Containing Window</em>}'
	...
	/**
	 * The cached value of the '{@link #getContainingToolbar() <em>Containing Toolbar</em>}'
	 * reference. <!-- begin-user-doc --> <!-- end-user-doc -->
	 * 
			...
			if (item != oldItem) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
						EcritdocumentPackage.INITIATABLE_ITEM__ITEM, oldItem, item));
			}
		}
		return item;
	}
	...
	public void setItemType(InitiatableItemType newItemType){
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
				EcritdocumentPackage.INITIATABLE_ITEM__ITEM_TYPE, oldItemType, itemType));
	}
	...
	public MWindow getContainingWindow(){
		if (containingWindow != null && ((EObject) containingWindow).eIsProxy()) {
			...
			if (containingWindow != oldContainingWindow) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
						EcritdocumentPackage.INITIATABLE_ITEM__CONTAINING_WINDOW,
						oldContainingWindow, containingWindow));
			}
		}
	...
	public void setContainingWindow(MWindow newContainingWindow){
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
				EcritdocumentPackage.INITIATABLE_ITEM__CONTAINING_WINDOW, oldContainingWindow,
				containingWindow));
	}
	...
	public MPart getContainingPart(){
		if (containingPart != null && ((EObject) containingPart).eIsProxy()) {
			...
			if (containingPart != oldContainingPart) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
						EcritdocumentPackage.INITIATABLE_ITEM__CONTAINING_PART, oldContainingPart,
						containingPart));
			}
		}
	...
	public MMenu getContainingMenu(){
		if (containingMenu != null && ((EObject) containingMenu).eIsProxy()) {
			...
			if (containingMenu != oldContainingMenu) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
						EcritdocumentPackage.INITIATABLE_ITEM__CONTAINING_MENU, oldContainingMenu,
						containingMenu));
			}
		}
	...
	public MToolBar getContainingToolbar(){
		if (containingToolbar != null && ((EObject) containingToolbar).eIsProxy()) {
			...
			if (containingToolbar != oldContainingToolbar) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
						EcritdocumentPackage.INITIATABLE_ITEM__CONTAINING_TOOLBAR,
						oldContainingToolbar, containingToolbar));
			}
		}
	...
	public void setContainingToolbar(MToolBar newContainingToolbar){
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
				EcritdocumentPackage.INITIATABLE_ITEM__CONTAINING_TOOLBAR, oldContainingToolbar,
				containingToolbar));
	}
	...
	public MExpression getVisibleWhen(){
		if (visibleWhen != null && ((EObject) visibleWhen).eIsProxy()) {
			...
			if (visibleWhen != oldVisibleWhen) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
						EcritdocumentPackage.INITIATABLE_ITEM__VISIBLE_WHEN, oldVisibleWhen,
						visibleWhen));
			}
		}
		return visibleWhen;
	...
	public void setVisibleWhen(MExpression newVisibleWhen){
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
				EcritdocumentPackage.INITIATABLE_ITEM__VISIBLE_WHEN, oldVisibleWhen, visibleWhen));
	}
	...
	public Step getAssociatedStep(){
		if (associatedStep != null && associatedStep.eIsProxy()) {
			...
			if (associatedStep != oldAssociatedStep) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE,
						EcritdocumentPackage.INITIATABLE_ITEM__ASSOCIATED_STEP, oldAssociatedStep,
						associatedStep));
			}
		}
	...
	public void setAssociatedStep(Step newAssociatedStep){
		if (newAssociatedStep != associatedStep) {
			...
			if (associatedStep != null)
				msgs =
					((InternalEObject) associatedStep).eInverseRemove(this,
						EcritdocumentPackage.STEP__INITIATABLE_BY, Step.class, msgs);
			if (newAssociatedStep != null)
				msgs =
					((InternalEObject) newAssociatedStep).eInverseAdd(this,
						EcritdocumentPackage.STEP__INITIATABLE_BY, Step.class, msgs);
			...
			eNotify(new ENotificationImpl(this, Notification.SET,
				EcritdocumentPackage.INITIATABLE_ITEM__ASSOCIATED_STEP, newAssociatedStep,
				newAssociatedStep));
	}
	 ...
	 * @generated not
	 */
	public Map<?, ?> getLocationDescription(){
