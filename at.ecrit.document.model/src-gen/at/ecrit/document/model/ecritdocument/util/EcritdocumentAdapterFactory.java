...
public class EcritdocumentAdapterFactory extends AdapterFactoryImpl {
	...
	protected EcritdocumentSwitch<Adapter> modelSwitch =
		new EcritdocumentSwitch<Adapter>() {
			...
			@Override
			public Adapter caseDocumentedMenu(DocumentedMenu object) {
	...
	/**
	 * Creates a new adapter for an object of class '{@link at.ecrit.document.model.ecritdocument.DocumentedMenu <em>Documented Menu</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
